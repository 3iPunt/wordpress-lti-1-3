...
if (empty($key_set_url)) {
    /*echo $client_id."<pre>";
    print_r($_SESSION['issuers']);*/
    $key_set_url = 'https://lti-ri.imsglobal.org/platforms/69/platform_keys/61.json';
}

$response = get_curl($key_set_url);
...
echo "<pre>".print_r($jwt_body, 1).'</pre>';
